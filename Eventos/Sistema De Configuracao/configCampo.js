...
const { QuickDB } = require("../../lib/quickdb-shim");
        ...
        if (interaction.type == Discord.InteractionType.ModalSubmit) {
            if (interaction.customId === 'sdaju11111idsjjs123dua123') {
                ...
                if (a1 !== ``) {
                    if (regexPadrao.test(a1)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cor \`${a1}\` inválida (Principal).` })
                    }
                }
                if (a2 !== ``) {
                    if (regexPadrao.test(a2)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cor \`${a2}\` inválida (Processamento).` })
                    }
                }
                if (a3 !== ``) {
                    if (regexPadrao.test(a3)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cor \`${a3}\` inválida (Sucesso).` })
                    }
                }
                if (a4 !== ``) {
                    if (regexPadrao.test(a4)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cor \`${a4}\` inválida (Falha).` })
                    }
                }
                if (a5 !== ``) {
                    if (regexPadrao.test(a5)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cor \`${a5}\` inválida (Finalizado).` })
                    }
                }
            ...
            if (interaction.customId === 'sdaju11111231idsjjs123dua123') {
                ...
                if (a1 !== ``) {
                    try {
                        ...
                        return interaction.followUp({ ephemeral: true, content: `${Emojis.get(`negative`)} Nome inserido \`${a1}\` inválido ou então você alterou mais de 3 vezes o nome em 1 hora!` })
                    }
                }
                if (a2 !== ``) {
                    try {
                        ...
                        return interaction.followUp({ ephemeral: true, content: `${Emojis.get(`negative`)} Avatar inserido \`${a2}\` inválido.` })
                    }
                }
                ...
                await interaction.followUp({ content: `${Emojis.get(`checker`)} | Configurações atualizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'dassdadassddsdasddassddasd') {
                ...
                if (ADD !== ``) {
                    ...
                    if (ddd == null) return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cargo inserido \`${ADD}\` inválido.` })
                ...
                if (REM !== ``) {
                    ...
                    if (ddd == null) return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cargo inserido \`${REM}\` inválido.` })
            ...
            if (interaction.customId === 'cargosremaddmodal') {
                ...
                interaction.followUp({ content: `${Emojis.get(`checker`)} | Cargos configurados com sucesso!`, ephemeral: true })
            }
            ...
            if (interaction.customId === 'configcampoo') {
                ...
                if (isNaN(preco)) return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Preço inserido \`${preco}\` inválido.` })
                ...
                if (ggg.camposelect !== nomecampo) {
                    ...
                    if (produtoExistente) return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Nome do campo já existente.` })
                }
                ...
                interaction.followUp({ content: `${Emojis.get(`checker`)} | Informações do campo atualizadas com sucesso!`, ephemeral: true })
            }
            ...
            if (interaction.customId == 'definircondicoes') {
                ...
                if (idcargo !== ``) {
                    ...
                    if (ddd == null) return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Cargo inserido \`${idcargo}\` inválido.` })
                }

                if (valorminimo !== ``) {
                    valorminimo = parseInt(valorminimo, 10);
                    if (!Number.isInteger(valorminimo)) {
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Quantidade inserida \`${valorminimo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
                ...
                if (valormaximo !== ``) {
                    ...
                    if (!Number.isInteger(valormaximo)) {
                        return interaction.reply({ ephemeral: true, content: `${Emojis.get(`negative`)} Quantidade inserida \`${valormaximo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
                ...
                interaction.followUp({ content: `${Emojis.get(`checker`)} | Condições atualizadas com sucesso!`, ephemeral: true })
            }
...
**Deseja adicionar o valor de \`${qtdlinhas}\`\ itens ao estoque de \`${ggg22.campo}\`?**
            ...
            if (interaction.customId == 'sd1213aju11111idsjjsdua') {
                ...
                if (qtd > 100000) return interaction.reply({ content: `${Emojis.get(`negative`)} Não foi possível adicionar esse estoque.`, ephemeral: true })

                if (isNaN(qtd)) return interaction.reply({ content: `${Emojis.get(`negative`)} Esse número não é válido \`${qtd}\`.`, ephemeral: true })
                ...
                await interaction.reply({ content: `${Emojis.get(`loading`)} Aguarde...`, ephemeral: true }).then(async tt => {
                    ...
                    // Notificação automática de stock
                    try {
            ...
            if (interaction.customId == 'sdaju11124124111231idsjjs123dua123') {
                ...
                if (qtd !== `sim`) return interaction.reply({ content: `${Emojis.get(`negative`)} Confirmação não validada.`, ephemeral: true });
                ...
                try {
                    await UpdateMessageProduto(client, ggg.name);
                    interaction.followUp({ content: `${Emojis.get(`checker`)} | Estoque limpo com sucesso!`, ephemeral: true });
                } catch (error) {
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId == `estoquearquivo`) {
                ...
                interaction.reply({ ephemeral: true, content: `${Emojis.get(`info`)} Envie um ou mais arquivo de texto contendo o estoque que deseja adicionar, expira <t:${Math.ceil(timeStamp / 1000)}:R>.` }).then(msgggg => {
            ...
            if (interaction.customId.startsWith(`avisarestoqueeeee`)) {
                ...
                if (yy == 0 || yy == undefined) return interaction.update({ content: `${Emojis.get(`negative`)} Nenhum usuário para avisar.`, ephemeral: true, components: [] })
            ...
            if (interaction.customId == `estoquedsadas`) {
                ...
                if (gggaaa.estoque == 0) {
                    interaction.reply({ content: `${Emojis.get(`negative`)} O estoque desse item está vazio.`, ephemeral: true })
                } else {
